...
import { BookingFormData, UserType, PaymentIntentResponse } from '../../../../backend/src/shared/types';
...
const BookingForm = ({ currentUser, paymentIntent }: Props) => {
  ...
  const onSubmit = async (formData: BookingFormData) => {
    ...
    if (result.error) {
      showToast({ message: result.error.message || 'Error has occurred', type: 'ERROR' });
      return;
    }
